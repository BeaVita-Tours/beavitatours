        ...
        <DialogHeader>
          ...
          <DialogDescription className="space-y-3">
            <span className="block">
              Choose which optional categories may run. Necessary cookies remain
              active because they are required for the site to function.
            </span>
            <Link
              href="/privacy"
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-start justify-between gap-4 rounded-xl border p-4">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Used to measure advertising performance and support remarketing.
                This category only loads after you consent.
              </p>
            </div>
            <Switch
              id="cookie-marketing"
