    ...
    <main>
      ...
      <section className="relative h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">PROSECCO TOUR</h1>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
              <p className="leading-relaxed">
                Just a 45 minute drive from Venice lies the region of Prosecco, UNESCO World Heritage Site.
              </p>
              <p className="leading-relaxed">
                On this tour we drive through the Prosecco Road that accommodates the finest vines and wineries where
                the highest quality Proseccos are produced. The landscape is without an end, villas on hills, hamlets,
                vineries...
              </p>
              <p className="leading-relaxed">
                In a Prosecco full day tour you can visit at least 3 wineries with sightseeing and time for a lunch stop
                in a family-run restaurant with excellent food and wine!
              </p>
              <p className="leading-relaxed">
                Pick-up and drop off of our tours are from Venice Piazzale Roma, the car terminal, to avoid any stress
                and waste of time to travel by train or by bus. Of course we can pick you up at any local hotel in the
                mainland.
              </p>
              <p className="leading-relaxed">
                We provide wine shipping service to all the countries with proper package to ensure that your shipment
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to Experience Prosecco Country?</h2>
